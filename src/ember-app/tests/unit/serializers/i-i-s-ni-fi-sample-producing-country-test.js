...
moduleForModel('i-i-s-ni-fi-sample-producing-country', 'Unit | Serializer | i-i-s-ni-fi-sample-producing-country', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-ni-fi-sample-producing-country',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
